...
//         key: 0,
//         title: "Team A",
//         data: ["Talha Maqsood", "Sheraz Perwaiz", "Alizay Shah"]
//     },
//     {
//         key: 1,
//         title: "Team B",
//         data: ["Nihal Siddique", "Samundar Khan", "Hamza Khan"]
//     },
//     {
//         key: 2,
//         title: "Team C",
//         data: ["Nauman Khan", "Ayesha Butt", "Niswar Khan"]
//     },
        ...
        return (
            <View style={styles.container_style}>
                ...
                {/* <SectionList
                        ...
                        <TouchableOpacity activeOpacity={1} onPress={() => onPress(item.name)}>
                            <View style={styles.item_style}>
                                <View style={{ flexDirection: "row", justifyContent: "flex-start", alignItems: "center", flex: 1 }}>
                                    ...
                                    <Text style={styles.item_heading}>{item.name}</Text>
                                </View>
                    ...
                    renderSectionHeader={({ section }) => <Text style={styles.section_style}>{section.username}</Text>}
